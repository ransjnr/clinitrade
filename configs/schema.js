...
export const InstrumentListing = pgTable("carLisiting", {
  ...
  userName: varchar("userName").notNull().default("Clinitrade"),
...
export const InstrumentImages = pgTable("carImages", {
  id: serial("id").primaryKey(),
  imageUrl: varchar("imageUrl").notNull(),
  instrumentListingId: integer("carListingId")
    .notNull()
    .references(() => InstrumentListing.id),
});
